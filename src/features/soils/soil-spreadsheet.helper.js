...
const NUTRIENT_HEADER_MAP = {
  ...
  cecTotal: ['t', 'ctc_total', 'ctc_ph7', 'ctc_a_ph_7'],
  aluminumSaturation: ['saturacao_aluminio', 'saturacao_por_aluminio', 'm'],
  acidezPotencial: ['h_al', 'h_al_', 'h_mais_al', 'acidez_potencial'],
  aluminum: ['aluminio', 'al'],
  totalCarbon: ['cot', 'carbono_organico', 'carbono_organico_total', 'c_org'],
  sand: ['areia'],
  silt: ['silte'],
  clay: ['argila'],
